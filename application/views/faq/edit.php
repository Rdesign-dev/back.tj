    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <?= form_open('faq/edit/' . $faq['id']); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="question">Pertanyaan</label>
                    <div class="col-md-6">
                        <textarea id="question" name="question" class="form-control" rows="3"><?= set_value('question', $faq['question']); ?></textarea>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="answer" name="answer" class="form-control" rows="5"><?= set_value('answer', $faq['answer']); ?></textarea>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <select name="status" id="status" class="form-control">
                            <option value="Active" <?= set_select('status', 'Active', ($faq['status'] == 'Active')); ?>>Active</option>
                            <option value="inactive" <?= set_select('status', 'inactive', ($faq['status'] == 'inactive')); ?>>Inactive</option>
                        </select>
