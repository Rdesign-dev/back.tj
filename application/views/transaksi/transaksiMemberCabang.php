<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body">
                <form action="<?= base_url('transaksicabang/convert_and_updateCabang') ?>" method="post" enctype="multipart/form-data" id="transactionForm">
                    ...
                    <!-- Split Bill Fields (Hidden by default) -->
                    <div id="splitBillFields" style="display:none;">
                        <div class="row form-group">
                            <label class="col-md-4 text-md-right">Jumlah Pembayaran Pertama</label>
                            <div class="col-md-6">
                                <input type="number" id="primary_amount" name="primary_amount" class="form-control" min="1000">
