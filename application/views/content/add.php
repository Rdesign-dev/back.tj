        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('content') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body pb-2">
                ...
                <?php echo form_open_multipart('content/tambah_save'); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="gambar">Foto Konten</label>
                    <div class="col-md-6">
