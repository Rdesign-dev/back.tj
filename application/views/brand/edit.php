            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="https://terasjapan.com/ImageTerasJapan/logo/<?= $brand['image'] ?>" class="img-thumbnail">
                            </div>
                            <div class="col">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="https://terasjapan.com/ImageTerasJapan/banner/<?= $brand['banner'] ?>" class="img-thumbnail">
                            </div>
                            <div class="col">
