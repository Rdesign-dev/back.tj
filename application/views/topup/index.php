            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="https://terasjapan.com/ImageTerasJapan/transaction_proof/Topup/<?= $tran->transaction_evidence ?>"
                            alt="Transfer Evidence" width="150" height="100">
                        <?php else: ?>
                        <img src="https://terasjapan.com/ImageTerasJapan/transaction_proof/struk.png" 
                            alt="Transfer Evidence" width="150" height="100">
                        <?php endif; ?>
                    </td>
                </tr>
