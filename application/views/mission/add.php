<!-- filepath: c:\laragon\www\back.tj\application\views\mission\add.php -->
<div class="container mt-4">
    <h4 class="mb-3">Tambah Mission</h4>
    <form method="post">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="point_reward" id="point_reward" class="form-control" value="<?= set_value('point_reward'); ?>">
