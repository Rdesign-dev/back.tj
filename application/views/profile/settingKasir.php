    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open_multipart('profilekasir/settingKasir', [], ['id' => $user['id']]); ?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-3">
                                <img src="<?= base_url('https://terasjapan.com/ImageTerasJapan/ProfPic/') . $user['photo']; ?>" 
                                     alt="<?= $user['Name']; ?>" 
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('Name', $user['Name']); ?>" 
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('phone_number', $user['phone_number']); ?>" 
